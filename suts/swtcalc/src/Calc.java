...
public class Calc {
	...
	public void createComponents() {
		...
		MenuItem6.setText("CriticalMessageBox");
		...
		MenuItem6.addSelectionListener(new SelectionAdapter(){
			public void widgetSelected(SelectionEvent e){
				...
				mb.setMessage("An unexpected error occurred!");
				mb.open();
			}
		});
		...
		MenuItem12.setText("External Process");
