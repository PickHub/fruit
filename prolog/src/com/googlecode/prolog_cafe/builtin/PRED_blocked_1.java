...
public final class PRED_blocked_1 extends Predicate.P1 {
	...
	public PRED_blocked_1(Term a1, Operation cont) {
		this.arg1 = a1;
		this.cont = cont;
	}
	...
	static final class Comparator extends Operation{
		...
		public Operation exec(Prolog engine) throws PrologException {
			...
			try{
				boolean b = Utils.Blocked((IWidget)arg.toJava());
	...
	static final class Iterator extends Operation{
		...
		IWidget getNextBlocked(){
			IWidget ret;
			while(i < max){
				ret = it.next();
				i++;
				if(Utils.Blocked(ret))
					return ret;
			}
			return null;
		}
